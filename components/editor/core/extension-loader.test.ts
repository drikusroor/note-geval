...
import { loadExtensions, composeExtensions } from "./extension-loader";
...
describe("extension-loader", () => {
  test("loadExtensions extracts raw extensions from EditorExtension objects", () => {
    ...
    const editorExtensions = [
      { extension: dummyExtension, id: "test-ext" }
    ];
  ...
  test("composeExtensions handles both raw extensions and EditorExtension objects", () => {
    ...
    const wrappedExt = { extension: EditorState.allowMultipleSelections.of(true) };
